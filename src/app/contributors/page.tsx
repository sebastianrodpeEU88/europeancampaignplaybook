    ...
    <div className="bg-[#FDF6EC] min-h-screen py-12">
      <Container>
        <div className="max-w-4xl mx-auto">
          <div className="mb-10">
            <h1 className="text-3xl font-bold text-[#2B0A2E] mb-2">Contributors</h1>
          ...
          <div className="mt-12 rounded-2xl border border-[rgba(0,0,0,0.08)] bg-white p-8">
            <h2 className="text-xl font-bold text-[#2B0A2E] mb-4">Contributor model</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-sm text-[#4A1F4D]">
              <div>
                <p className="font-semibold text-[#2B0A2E] mb-1">Editorial independence</p>
                <p className="text-[#7A6380] leading-relaxed">
              ...
              <div>
                <p className="font-semibold text-[#2B0A2E] mb-1">Mandatory disclosure</p>
                <p className="text-[#7A6380] leading-relaxed">
              ...
              <div>
                <p className="font-semibold text-[#2B0A2E] mb-1">Peer review</p>
                <p className="text-[#7A6380] leading-relaxed">
