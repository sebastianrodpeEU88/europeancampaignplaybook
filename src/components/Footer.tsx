    ...
    <footer className="mt-16 border-t border-[rgba(0,0,0,0.08)] bg-white">
      <Container>
        <div className="py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Brand */}
          <div>
            <p className="font-semibold text-[#2B0A2E] mb-2">Campaign Intelligence Library</p>
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="text-sm text-[#7A6380] hover:text-[#2B0A2E] transition-colors duration-150 focus-visible:outline-none focus-visible:underline"
                    >
                      {link.label}
                    </Link>
                  </li>
          ...
          <div>
            ...
            <p className="text-xs text-[#7A6380] leading-relaxed" role="note">
        ...
        <div className="border-t border-[rgba(0,0,0,0.08)] py-6">
          <p className="text-xs text-[#A896AC] leading-relaxed max-w-4xl" role="note">
          ...
          <p className="mt-2 text-xs text-[#A896AC]">
