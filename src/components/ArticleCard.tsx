  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-2 flex-wrap">
        <span className="rounded-full bg-[rgba(0,0,0,0.05)] px-2.5 py-0.5 text-xs font-medium text-[#6B7280]">
          {article.type}
        </span>
        <span className="rounded-full bg-[rgba(0,0,0,0.04)] px-2.5 py-0.5 text-xs text-[#9CA3AF]">
          {article.difficulty}
        </span>
        {article.locked && (
          <span className="ml-auto flex items-center gap-1 text-xs text-[#9CA3AF]" aria-label="Members only">
      ...
      {/* Title */}
      <h3 className="font-semibold text-[#1C1C1E] group-hover:text-[#374151] transition-colors leading-snug mb-1">
        {article.title}
      </h3>
